...
Varying force $\lambda(\Gamma)$ is a _Gaussian fluxstat_ which holds constant the weighted flux $J \equiv \sum_i w_i \mathbf{p}_{i}\cdot\mathbf{i}$, such as
...
Varying force is a _Nose-Hoover fluxstat_.
